...
### 풀이 방법
 <p>처음에 접근했던 방법은 정사각형의 개수 * 100을 한 후에, 겹치는 부분을 빼려고 했었다. 하지만 반례가 있었고, x,y값을 받아 그 칸부터 10칸 뒤까지 1을 넣어주었고 그 1을 모두 더해주면 색칠된 값이 나온다는 아이디어를 얻었다.</p>
 <p>문제를 어렵게 접근하는 경향이 있는 것 같은데, 조금은 단순하게 생각해보자!!</p>
