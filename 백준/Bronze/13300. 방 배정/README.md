...
### 문제 풀이
 <p>접근 자체를 어려워했었다. student 배열을 7*2 크기로 만들었고, grade와 gender로 받은 값에 맞게 student 배열을 1씩 증가시켰다.</p>
 <p>이후에는 나머지 연산자를 이용해 0과 0이 아닌 경우를 나누어 방의 개수를 구해주었다.</p>
